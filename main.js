...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            imports: [
                _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClientModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_6__["AppRoutingModule"]
            ],
...
var CommonService = /** @class */ (function () {
    function CommonService(http) {
        this.http = http;
        this.dbUrl = "https://jsonplaceholder.typicode.com/";
    }
    CommonService.prototype.getPosts = function () {
        return this.http.get(this.dbUrl + 'posts');
    };
    CommonService.prototype.getComments = function () {
        return this.http.get(this.dbUrl + 'comments');
    };
    CommonService.prototype.getAlbums = function () {
        return this.http.get(this.dbUrl + 'albums');
    };
    CommonService.prototype.getPhotos = function () {
        return this.http.get(this.dbUrl + 'photos');
    };
    CommonService.prototype.getTodos = function () {
        return this.http.get(this.dbUrl + 'todos');
    };
    ...
    CommonService.prototype.getUserId = function (id) {
        return this.http.get(this.dbUrl + 'users/' + [id]);
    };
...
module.exports = __webpack_require__(/*! D:\Projects\Angular-5\modulePrj\src\main.ts */"./src/main.ts");
